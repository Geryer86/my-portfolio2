      ...
      <Container>
        <Row className="align-item-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <p>I'm a Full Stack Developer graduated in the SoyHenry Bootcamp. I was born in Argentina and currently living in north Italy. I'm also an Agricultural Engineer graduated in the Rosario National University (UNR) in Rosario, Argentina. I speak spanish (native), english (fluent), italian (advanced) and portuguese (intermediate).</p>
            <CTA/>
            <Router>
